...
/**
 * Represents a <code>CashRegister</code> that handles the store's cash.
 * Updated by {@link Controller} during payment.
 */
public class CashRegister {
    ...
    /**
     * Creates a new instance with the initial balance.
     */
    public CashRegister() {
